...
const jaci = () => {
    ...
    const testSelect = (str, conf) => {
        try {
            let selected = Object.keys(conf?.options)?.find((n) => conf?.options?.[n]?.toString()?.toLowerCase() === str?.toLowerCase())
